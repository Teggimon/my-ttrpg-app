            ...
            <div className="prof-add-cat-row">
              {addingCat ? (
                <form onSubmit={e => { e.preventDefault(); addCategory(newCat) }} style={{ display:'flex', gap:6, width:'100%' }}>
                  ...
                  <button type="submit" style={{ background:'var(--accent)', border:'none', borderRadius:'var(--radius-md)', color:'var(--accent-text)', fontSize:11, fontWeight:700, padding:'4px 10px', cursor:'pointer', fontFamily:'var(--font-body)' }}>Add</button>
